...
import { Bug, CheckCircle2, AlertCircle, Plus } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <StatCard index={0} icon={Bug}          label="My Bugs"  value={bugs.length}  sub="All reported"  accent="#000093" />
          <StatCard index={1} icon={AlertCircle}  label="Open"     value={openBugs}     sub="Awaiting fix"  accent="#ef4444" />
          <StatCard index={2} icon={CheckCircle2} label="Solved"   value={solvedBugs}   sub="Resolved"      accent="#01ab77" />
        </div>
      )}
